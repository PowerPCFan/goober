...
class EightballRenderer:
    ...
    def _truncate_text(
        self, draw: ImageDraw.ImageDraw, text: str, font: ImageFont.FreeTypeFont, max_width: float
    ) -> str:
    ...
    def generate_eightball_gif(
        self, choice: str, output_path: pathlib.Path, question: str, username: str
    ) -> None:
        ...
        frames[0].save(
            fp=output_path, save_all=True, append_images=frames[1:], duration=80, loop=0, disposal=2
        )
